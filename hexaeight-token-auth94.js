    ...
    function main() {
        ...
        jQuery(document).ready(function ($) {
            ...
            $(document).ready(function () {
			    ...
			    console.log(location.protocol + "//" + servername + path + "login");
			    console.log(recievedataurl + "|" + cv);
                            let pushresp = await postdata(location.protocol + "//" + servername + path + "login", recievedataurl + "|" + cv );
                            pushresp.then(function () {
