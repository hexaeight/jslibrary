export default class {
	constructor() { var CryptoJS = require("crypto-js"); }
	...
	export default function EncryptBearerMessage(data, captchasecret, codeverifier) {
		return AES_Fast_Encrypt(codeverifier + captchasecret + codeverifier, data);
	}

	export default function DecryptBearerMessage(encrypteddata, captchasecret, codeverifier) {
