                        ...
                        else
                        {
                            ...
                            cc.then(function (challenge) {
                                console.log("Generated Challenge Code");
                                        ...
                                        qrcodedata = "Hexa8VAUTH|" + qrcodeid + "|" + datasinkprotocol + "|" + challenge + ":" + clientappcode + "|" + datasinkurl + "/" + recievedataurl;
                                        console.log("Generated QRCode");
                                        document.getElementById("display-hexaeight-qrcodeid").innerHTML = "";
                                        document.getElementById("display-hexaeight-qrcodeid").innerHTML = "<b>" + qrcodeid + "</b>"  ;
                                        document.getElementById("display-hexaeight-qrcode").innerHTML = "";
