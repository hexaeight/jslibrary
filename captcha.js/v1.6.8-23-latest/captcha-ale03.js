...
HexaEightCaptcha.prototype = (function() {
	...
	var bearertoken ="";
        ...
        async function InitializeQuickALE(code) {
        ...
        function InitializeDefaultALE(code) {
		...
		InitializeDefaultALE(code);
	    }
	    if (aleconfig == "Quick") {
		InitializeQuickALE(code);
	    }
        }
	...
	function FetchQuickEncryptedCodeVerifier() {
		return AES_Quick_Encrypt(email + codeverifier);			
	}
