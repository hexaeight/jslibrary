...
$("button").on('click',function() {
    var customCss = "<style>div#qrcode div {  text-align: center; } .opacity { pointer-events: none; opacity: 0.5; }div img { margin: 0 auto; }div#qrcode span {background: #000;display: inline-block;color: #fff;}</style>"
