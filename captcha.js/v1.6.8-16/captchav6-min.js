...
$("button").on('click',function() {
    ...
    var customCss = "<style>div#qrcode div {  text-align: center; } div#qrcode div button { margin-top: 20px; } .opacity { pointer-events: none; opacity: 0.5; }div img { margin: 0 auto; margin-top: 30px; }div#qrcode span {min-width: 256px;background: #000;display: inline-block;color: #fff;padding: 10px;margin-top: 2px;margin-bottom:20px;}</style>"
    ...
    if(inputBox.value != '') {
        ...
        fetch(_fetchCaptchaUrl, {
            ...
            .then(response => {
                ...
                $('.loader').hide();
                var modalpopup = "<div id='myModal' class='modal fade' role='dialog'><div class='modal-dialog'><div class='modal-content'><div class='modal-header'><h4 class='modal-title text-center'>Use <a href='https://www.hexaeight.com/help/how-to-create-your-first-digital-token.html' target='_blank'>HexaEight Digital Token</a> To Scan This QR Code</h4></div><div class='modal-body'><div class='loader'></div><div id='qrcode'></div></div></div></div></div>"; 
