...
$("button").on('click',function() {
    ...
    var customCss = "<style>div#qrcode div {  text-align: center; } .opacity { pointer-events: none; opacity: 0.5; }</style>"
    ...
    if(inputBox.value != '') {
        ...
        fetch(_fetchCaptchaUrl, {
            ...
            .then(response => {
                ...
                var modalpopup = "<div id='myModal' class='modal fade' role='dialog'><div class='modal-dialog'><div class='modal-content'><div class='modal-header'><h4 class='modal-title text-center'>Use <a href='https://www.hexaeight.com/help/how-to-create-your-first-digital-token.html' target='_blank'>HexaEight Digital Token</a> To Scan This QR Code</h4></div><div class='modal-body'><div class='loader'></div><div {  height: 200px;  width: 200px;   background-color: powderblue; } id='qrcode'></div></div></div></div></div>"; 
