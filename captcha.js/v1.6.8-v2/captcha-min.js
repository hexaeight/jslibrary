...
$("button").on('click',function() {
    ...
    var customCss = "div#qrcode div {  text-align: center; } div#qrcode div button { margin-top: 20px; } .opacity { pointer-events: none; opacity: 0.5; }"
    ...
    if(_this.previousElementSibling.value  != '') {
        ...
        fetch(_fetchCaptchaUrl, {
            ...
            .then(response => {
                ...
                $('.loader').hide();
                var successFunction = $(this).attr('data-hexaeight-success-function');
	        ...
	        var modalstyle = "div#qrcode div {  text-align: center; } div#qrcode div button { margin-top: 20px; } .opacity { pointer-events: none; opacity: 0.5; }"
